...
"}")
        ...
        self.btn_merge.setMinimumSize(QtCore.QSize(80, 0))
...
"")
        ...
        self.comboBox_output_dir = QtWidgets.QComboBox(merge_pdf_view)
        ...
        self.btn_choose_output_dir = QtWidgets.QPushButton(merge_pdf_view)
    ...
    def retranslateUi(self, merge_pdf_view):
        ...
        self.comboBox_output_dir.setItemText(0, _translate("merge_pdf_view", "PDF相同目录"))
        self.comboBox_output_dir.setItemText(1, _translate("merge_pdf_view", "自定义目录"))
        self.btn_choose_output_dir.setText(_translate("merge_pdf_view", "···"))
