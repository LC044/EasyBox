...
################################################################################
## Form generated from reading UI file 'toc_ui.ui'
##
...
class Ui_toc_view(object):
    def setupUi(self, toc_view):
        if not toc_view.objectName():
            toc_view.setObjectName(u"toc_view")
        toc_view.resize(668, 614)
        toc_view.setStyleSheet(u"")
        self.verticalLayout_3 = QVBoxLayout(toc_view)
        self.verticalLayout_3.setSpacing(0)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.label_8 = QLabel(toc_view)
...
"}")
        ...
        self.progressBar = QProgressBar(toc_view)
        ...
        self.btn_merge = QPushButton(toc_view)
        ...
        self.retranslateUi(toc_view)

        QMetaObject.connectSlotsByName(toc_view)
    # setupUi

    def retranslateUi(self, toc_view):
        toc_view.setWindowTitle(QCoreApplication.translate("toc_view", u"Form", None))
        self.label_8.setText(QCoreApplication.translate("toc_view", u"\u751f\u6210PDF\u4e66\u7b7e\u76ee\u5f55", None))
        self.checkBox_select_all.setText(QCoreApplication.translate("toc_view", u"\u540d\u79f0", None))
        self.btn_order_inc.setText(QCoreApplication.translate("toc_view", u"\u25b2", None))
        self.btn_order_des.setText(QCoreApplication.translate("toc_view", u"\u25bc", None))
        self.label.setText(QCoreApplication.translate("toc_view", u"\u9875\u6570", None))
        self.label_2.setText(QCoreApplication.translate("toc_view", u"\u8f93\u51fa\u8303\u56f4", None))
        self.label_3.setText(QCoreApplication.translate("toc_view", u"\u72b6\u6001", None))
        self.label_4.setText(QCoreApplication.translate("toc_view", u"\u64cd\u4f5c", None))
        self.btn_remove_selected.setText(QCoreApplication.translate("toc_view", u"\u6e05\u9664\u9009\u4e2d", None))
        self.btn_choose_files.setText(QCoreApplication.translate("toc_view", u"\u6dfb\u52a0\u6587\u4ef6", None))
        self.btn_setting.setText(QCoreApplication.translate("toc_view", u"\u8bbe\u7f6e", None))
        self.btn_merge.setText(QCoreApplication.translate("toc_view", u"\u5f00\u59cb\u8f6c\u6362", None))
    # retranslateUi
