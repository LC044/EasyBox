...
# Form implementation generated from reading ui file 'toc_ui.ui'
#
...
class Ui_toc_view(object):
    def setupUi(self, toc_view):
        toc_view.setObjectName("toc_view")
        toc_view.resize(668, 614)
        toc_view.setStyleSheet("")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(toc_view)
        self.verticalLayout_3.setSpacing(0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.label_8 = QtWidgets.QLabel(toc_view)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.verticalLayout_3.addWidget(self.label_8)
        self.frame1 = QtWidgets.QFrame(toc_view)
...
"}")
        ...
        self.widget1 = QtWidgets.QWidget(toc_view)
...
"}")
        ...
        self.progressBar = QtWidgets.QProgressBar(toc_view)
        ...
        self.btn_merge = QtWidgets.QPushButton(toc_view)
        ...
        QtCore.QMetaObject.connectSlotsByName(toc_view)

    def retranslateUi(self, toc_view):
        _translate = QtCore.QCoreApplication.translate
        toc_view.setWindowTitle(_translate("toc_view", "Form"))
        self.label_8.setText(_translate("toc_view", "生成PDF书签目录"))
        self.checkBox_select_all.setText(_translate("toc_view", "名称"))
        self.btn_order_inc.setText(_translate("toc_view", "▲"))
        self.btn_order_des.setText(_translate("toc_view", "▼"))
        self.label.setText(_translate("toc_view", "页数"))
        self.label_2.setText(_translate("toc_view", "输出范围"))
        self.label_3.setText(_translate("toc_view", "状态"))
        self.label_4.setText(_translate("toc_view", "操作"))
        self.btn_remove_selected.setText(_translate("toc_view", "清除选中"))
        self.btn_choose_files.setText(_translate("toc_view", "添加文件"))
        self.btn_setting.setText(_translate("toc_view", "设置"))
        self.btn_merge.setText(_translate("toc_view", "开始转换"))
