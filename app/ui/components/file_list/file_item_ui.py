...
"}")
        ...
        self.label_size.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.widget_3.setMinimumSize(QtCore.QSize(99, 0))
        self.widget_3.setMaximumSize(QtCore.QSize(99, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.widget_2.setMinimumSize(QtCore.QSize(99, 0))
        self.widget_2.setMaximumSize(QtCore.QSize(99, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, file_item_widget):
        ...
        self.label_size.setText(_translate("file_item_widget", "0M"))
        self.label_page_num.setText(_translate("file_item_widget", "0"))
        self.label_2.setText(_translate("file_item_widget", "-"))
        self.label_result.setText(_translate("file_item_widget", "TextLabel"))
        self.btn_open.setToolTip(_translate("file_item_widget", "打开文件"))
        self.btn_open.setText(_translate("file_item_widget", "打开"))
