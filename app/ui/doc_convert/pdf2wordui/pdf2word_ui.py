...
################################################################################
## Form generated from reading UI file 'pdf2word_ui.ui'
##
...
class Ui_pdf2word_view(object):
    def setupUi(self, pdf2word_view):
        if not pdf2word_view.objectName():
            pdf2word_view.setObjectName(u"pdf2word_view")
        pdf2word_view.resize(668, 614)
        pdf2word_view.setStyleSheet(u"")
        self.verticalLayout_3 = QVBoxLayout(pdf2word_view)
        self.verticalLayout_3.setSpacing(0)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.label_8 = QLabel(pdf2word_view)
        ...
        self.frame1 = QFrame(pdf2word_view)
...
"}")
        ...
        self.widget1 = QWidget(pdf2word_view)
...
"}")
        ...
        self.progressBar = QProgressBar(pdf2word_view)
        ...
        self.comboBox_output_dir = QComboBox(pdf2word_view)
        ...
        self.btn_choose_output_dir = QPushButton(pdf2word_view)
        ...
        self.label_9 = QLabel(pdf2word_view)
        self.label_9.setObjectName(u"label_9")

        self.gridLayout.addWidget(self.label_9, 0, 0, 1, 1)

        self.label_output_dir = QLabel(pdf2word_view)
        ...
        self.btn_merge = QPushButton(pdf2word_view)
        self.btn_merge.setObjectName(u"btn_merge")
        self.btn_merge.setMinimumSize(QSize(60, 40))
...
"")
        ...
        self.horizontalLayout_4.addWidget(self.btn_merge)
        ...
        QMetaObject.connectSlotsByName(pdf2word_view)
    # setupUi

    def retranslateUi(self, pdf2word_view):
        pdf2word_view.setWindowTitle(QCoreApplication.translate("pdf2word_view", u"Form", None))
        self.label_8.setText(QCoreApplication.translate("pdf2word_view", u"PDF\u8f6cWord", None))
        self.checkBox_select_all.setText(QCoreApplication.translate("pdf2word_view", u"\u540d\u79f0", None))
        self.btn_order_inc.setText(QCoreApplication.translate("pdf2word_view", u"\u25b2", None))
        self.btn_order_des.setText(QCoreApplication.translate("pdf2word_view", u"\u25bc", None))
        self.label.setText(QCoreApplication.translate("pdf2word_view", u"\u9875\u6570", None))
        self.label_2.setText(QCoreApplication.translate("pdf2word_view", u"\u8f93\u51fa\u8303\u56f4", None))
        self.label_3.setText(QCoreApplication.translate("pdf2word_view", u"\u72b6\u6001", None))
        self.label_4.setText(QCoreApplication.translate("pdf2word_view", u"\u64cd\u4f5c", None))
        self.btn_remove_selected.setText(QCoreApplication.translate("pdf2word_view", u"\u6e05\u9664\u9009\u4e2d", None))
        self.btn_choose_files.setText(QCoreApplication.translate("pdf2word_view", u"\u6dfb\u52a0\u6587\u4ef6", None))
        self.btn_setting.setText(QCoreApplication.translate("pdf2word_view", u"\u8bbe\u7f6e", None))
        self.comboBox_output_dir.setItemText(0, QCoreApplication.translate("pdf2word_view", u"PDF\u76f8\u540c\u76ee\u5f55", None))
        self.comboBox_output_dir.setItemText(1, QCoreApplication.translate("pdf2word_view", u"\u81ea\u5b9a\u4e49\u76ee\u5f55", None))

        self.btn_choose_output_dir.setText(QCoreApplication.translate("pdf2word_view", u"\u00b7\u00b7\u00b7", None))
        self.label_9.setText(QCoreApplication.translate("pdf2word_view", u"\u8f93\u51fa\u76ee\u5f55:", None))
        self.label_output_dir.setText(QCoreApplication.translate("pdf2word_view", u"\u76ee\u5f55", None))
        self.btn_merge.setText(QCoreApplication.translate("pdf2word_view", u"\u5f00\u59cb\u8f6c\u6362", None))
    # retranslateUi
