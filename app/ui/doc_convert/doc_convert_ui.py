...
"}")
        ...
        self.commandLinkButton_pdf2img = QtWidgets.QCommandLinkButton(self.widget_4)
        ...
        self.commandLinkButton_pdf2img.setIcon(icon)
        ...
        self.gridLayout_3.addWidget(self.commandLinkButton_pdf2img, 0, 1, 1, 1)
